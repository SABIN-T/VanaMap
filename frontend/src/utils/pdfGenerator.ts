...
export const generateAndDownloadPDF = () => {
    try {
        ...
        doc.setFontSize(26);
        doc.text('VanaMapp Guide Book', 105, 40, { align: 'center' });
        ...
        addParagraph('VanaMapp isn\'t just a database; it IS a living simulation engine. We calculate a weighted average of your region\'s temperature for the last 30 days. We also calculate the "Respiratory Load" of your room based on the number of people vs plant oxygen output.');
        ...
        doc.text('Generated by VanaMapp Intelligence System • 2025', 105, 290, { align: 'center' });
        ...
        link.href = url;
        link.setAttribute('download', 'VanaMapp_Guide.pdf');
