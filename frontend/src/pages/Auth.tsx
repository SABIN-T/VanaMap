...
export const Auth = () => {
    ...
    const handleNudge = async () => {
        ...
        try {
            ...
            toast.success("Check your email for temporary password 123456 and send password to the respective gmail from the system do not spam it is very important msg", { id: tid, duration: 8000 });
