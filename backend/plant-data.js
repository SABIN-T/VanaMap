...
// Dictionary of 100+ Validated Species with accurate biometric and horticultural data.
...
const indoorPlants = [
    {
        ...
        idealTempMax: 29,
        minHumidity: 30,
        sunlight: "low", // Can tolerate low to high
        oxygenLevel: "very-high",
        medicinalValues: ["Air Purification (Benzene/Formaldehyde)", "Nighttime Oxygen Release"],
        advantages: ["Drought Tolerant", "Indestructible"],
        price: 25,
        type: "indoor",
        ...
        biometricFeatures: ["Horizontal Banding", "Sharp Apex"]
    },
    {
        id: "p_in_02",
        ...
        advantages: ["Fast Climber", "Statement Foliage"],
        price: 45,
        type: "indoor",
        ...
        biometricFeatures: ["Natural Leaf Holes", "Thick Aerial Roots"]
    },
    {
        id: "p_in_03",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Dramatic Height", "Structural"],
        price: 80,
        type: "indoor",
        ...
        biometricFeatures: ["Prominent Venation", "Large Leaf Surface"]
    },
    {
        id: "p_in_04",
        name: "Peace Lily",
        ...
        sunlight: "low",
        oxygenLevel: "very-high",
        medicinalValues: ["Mold Spore Removal", "Air Cleaning"],
        advantages: ["Visual Thirst Indicator", "Low Light Bloomer"],
        price: 30,
        type: "indoor",
        ...
        biometricFeatures: ["White Spathe", "Drooping when dry"]
    },
    {
        id: "p_in_05",
        name: "Golden Pothos",
        ...
        advantages: ["Fast Growing", "Propagates Easily"],
        price: 15,
        type: "indoor",
        ...
        biometricFeatures: ["Yellow Variegation", "Aerial Root Nubs"]
    },
    {
        id: "p_in_06",
        name: "ZZ Plant",
        ...
        advantages: ["Drought Resistant", "Low Light"],
        price: 35,
        type: "indoor",
        ...
        biometricFeatures: ["Bulbous Rhizomes", "Reflective Surface"]
    },
    {
        id: "p_in_07",
        name: "Spider Plant",
        ...
        advantages: ["Pet Safe", "Self-Propagating"],
        price: 20,
        type: "indoor",
        ...
        biometricFeatures: ["Central Stripe", "Plantlets"]
    },
    {
        id: "p_in_08",
        name: "Rubber Plant",
        ...
        advantages: ["Rapid Growth", "Bold Color"],
        price: 40,
        type: "indoor",
        ...
        biometricFeatures: ["Red Sheath (Stipule)", "White Sap"]
    },
    {
        id: "p_in_09",
        name: "Boston Fern",
        ...
        idealTempMin: 15,
        idealTempMax: 25,
        minHumidity: 70, // Needs high humidity
        sunlight: "medium",
        oxygenLevel: "very-high",
        medicinalValues: ["Air Humidification"],
        advantages: ["Lush Texture", "Non-Toxic"],
        price: 25,
        type: "indoor",
        ...
        biometricFeatures: ["Sori on underside", "Dense Leaflets"]
    },
    {
        id: "p_in_10",
        name: "Aloe Vera",
        ...
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["Burn Healing", "Skin Care"],
        advantages: ["Medicinal", "Drought Tolerant"],
        price: 15,
        type: "indoor",
        ...
        overallHabit: "Clumping",
        biometricFeatures: ["Serrated Margins", "Internal Gel"]
    },
    {
        id: "p_in_11",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["Air Purification"],
        advantages: ["Low Light Color", "Slow Growing"],
        price: 35,
        type: "indoor",
        ...
        overallHabit: "Bushy",
        biometricFeatures: ["Variegated Patterns", "Sheathed Petioles"]
    },
    {
        id: "p_in_12",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Huge Leaves", "Verticality"],
        price: 65,
        type: "indoor",
        ...
        biometricFeatures: ["Split Leaves (Wind)", "Thick Petioles"]
    },
    {
        id: "p_in_13",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Indestructible", "Pet Safe"],
        price: 45,
        type: "indoor",
        ...
        stemStructure: "Rhizomatous",
        overallHabit: "Clumping",
        biometricFeatures: ["Dark Green", "Long Petioles"]
    },
    {
        id: "p_in_14",
        name: "Majesty Palm",
        ...
        oxygenLevel: "very-high",
        medicinalValues: ["None"],
        advantages: ["Tropical Look", "Pet Safe"],
        price: 40,
        type: "indoor",
        ...
        overallHabit: "Upright/Vase",
        biometricFeatures: ["Symmetrical Fronds", "Thick Base"]
    },
    {
        id: "p_in_15",
        name: "Areca Palm",
        ...
        sunlight: "high",
        oxygenLevel: "very-high",
        medicinalValues: ["Xylene Removal"],
        advantages: ["Fine Texture", "Privacy Screen"],
        price: 55,
        type: "indoor",
        ...
        overallHabit: "Bushy",
        biometricFeatures: ["Yellowish Stems", "Multiple Trunks"]
    },
    {
        id: "p_in_16",
        name: "Prayer Plant",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Active Movement", "Pet Safe"],
        price: 25,
        type: "indoor",
        ...
        biometricFeatures: ["Red Veins", "Nyctinasty (Movement)"]
    },
    {
        id: "p_in_17",
        ...
        oxygenLevel: "low",
        medicinalValues: ["None"],
        advantages: ["Unique Shape", "Hanging Basket"],
        price: 20,
        type: "indoor",
        ...
        biometricFeatures: ["Translucent 'Window'", "Pea-like"]
    },
    {
        id: "p_in_18",
        name: "Jade Plant",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Symbol of Luck"],
        advantages: ["Longevity", "Easy Propagation"],
        price: 22,
        type: "indoor",
        foliageTexture: "Smooth/Fleshy",
        leafShape: "Obovate",
        ...
        overallHabit: "Tree-like",
        biometricFeatures: ["Red Edges in Sun", "Opposite Leaves"]
    },
    {
        id: "p_in_19",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Fast Growth", "Easy Care"],
        price: 18,
        type: "indoor",
        ...
        biometricFeatures: ["Central Lime Stripe", "Pinkish Stipules"]
    },
    {
        id: "p_in_20",
        name: "Dumb Cane",
        ...
        sunlight: "medium",
        oxygenLevel: "high",
        medicinalValues: ["None (Toxic Sap)"],
        advantages: ["Showy Foliage", "Air Purifying"],
        price: 30,
        type: "indoor",
        ...
        biometricFeatures: ["Speckled Patterns", "Thick Stem"]
    },
    {
        id: "p_in_21",
        ...
        stemStructure: "Vining",
        overallHabit: "Trailing/Climbing",
        biometricFeatures: ["Fully Perforated", "Rapid Runner"]
    },
    {
        id: "p_in_22",
        name: "Ponytail Palm",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Water Storage (Caudex)", "Non-Toxic"],
        price: 45,
        type: "indoor",
        ...
        overallHabit: "Tree-like",
        biometricFeatures: ["Bulbous Base", "Recurved Leaves"]
    },
    {
        id: "p_in_23",
        name: "Alocasia Polly",
        ...
        stemStructure: "Rhizomatous",
        overallHabit: "Upright",
        biometricFeatures: ["Scalloped Edges", "Contrasting Veins"]
    },
    {
        id: "p_in_24",
        name: "Croton",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Vibrant Color", "Tropical"],
        price: 25,
        type: "indoor",
        ...
        stemStructure: "Woody",
        overallHabit: "Bushy",
        biometricFeatures: ["Multicolor Variegation", "Stiff Leaves"]
    },
    {
        id: "p_in_25",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Pet Safe", "Designer Favorite"],
        price: 50,
        type: "indoor",
        ...
        stemStructure: "Rhizomatous",
        overallHabit: "Clumping",
        biometricFeatures: ["Silver Stripes", "Large Surface Area"]
    },
    // ... Additional indoor plants can be added here
];
...
const outdoorPlants = [
    {
        ...
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["Relaxation", "Antiseptic"],
        ...
        biometricFeatures: ["Square Stems", "Fragrant Oil Glands"]
    },
    {
        id: "p_out_02",
        name: "Garden Rose",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Vitamin C (Hips)", "Skin Oil"],
        advantages: ["Fragrance", "Cut Flowers"],
        price: 35,
        type: "outdoor",
        ...
        biometricFeatures: ["Thorns (Prickles)", "Stipules at base"]
    },
    {
        id: "p_out_03",
        name: "Hydrangea",
        ...
        idealTempMax: 25,
        minHumidity: 50,
        sunlight: "medium", // Morning sun, afternoon shade
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Massive Blooms", "Long Flowering"],
        price: 40,
        type: "outdoor",
        ...
        stemStructure: "Woody",
        overallHabit: "Mounding",
        biometricFeatures: ["Opposite Leaves", "Corymb Blooms"]
    },
    {
        id: "p_out_04",
        name: "Japanese Maple",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Focal Point", "Seasonal Color"],
        price: 120,
        type: "outdoor",
        ...
        biometricFeatures: ["5-7 Lobes", "Opposite Branching"]
    },
    {
        id: "p_out_05",
        name: "Sunflower",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Seeds (Nutrients)"],
        ...
        biometricFeatures: ["Hirsute Stem", "Ray & Disc Florets"]
    },
    {
        id: "p_out_06",
        name: "Boxwood",
        ...
        idealTempMax: 30,
        minHumidity: 40,
        sunlight: "medium", // Sun or shade
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Winter Interest", "Deer Resistant"],
        price: 30,
        type: "outdoor",
        ...
        biometricFeatures: ["Opposite Leaves", "Square young stems"]
    },
    {
        id: "p_out_07",
        name: "Peony",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Anti-inflammatory (Root)"],
        advantages: ["Long Lived (50+ yrs)", "Spectacular Bloom"],
        price: 45,
        type: "outdoor",
        ...
        overallHabit: "Clumping",
        biometricFeatures: ["Compound Leaves", "Ants on buds"]
    },
    {
        id: "p_out_08",
        name: "Hosta",
        ...
        imageUrl: "https://images.unsplash.com/photo-1596720512534-72210887ee2c", // Generic green foliage
        idealTempMin: -30,
        idealTempMax: 28,
        minHumidity: 60,
        sunlight: "low",
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Shade Garden Staple", "Ground Cover"],
        price: 15,
        type: "outdoor",
        ...
        stemStructure: "Rhizomatous",
        overallHabit: "Mounding",
        biometricFeatures: ["Parallel Venation", "Raceme Flower Spike"]
    },
    {
        id: "p_out_09",
        name: "Tomato",
        ...
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["Lycopene (Antioxidant)"],
        advantages: ["Edible", "Productive"],
        price: 8,
        type: "outdoor",
        ...
        biometricFeatures: ["Glandular Hairs", "Yellow Flowers"]
    },
    {
        id: "p_out_10",
        name: "Azalea",
        ...
        idealTempMax: 27,
        minHumidity: 50,
        sunlight: "medium", // Dappled shade
        oxygenLevel: "moderate",
        medicinalValues: ["None (Toxic)"],
        advantages: ["Spring Color", "Evergreen varieties"],
        price: 35,
        type: "outdoor",
        ...
        stemStructure: "Woody",
        overallHabit: "Bushy",
        biometricFeatures: ["Pubescent Leaves", "Funnel Flowers"]
    },
    {
        id: "p_out_11",
        name: "Rosemary",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Memory Boost", "Culinary"],
        advantages: ["Deer Resistant", "Drought Hardy"],
        price: 12,
        type: "outdoor",
        ...
        biometricFeatures: ["White underside", "Resinous Scent"]
    },
    {
        id: "p_out_12",
        name: "Tulip",
        ...
        idealTempMin: -20, // Bulbs need cold
        idealTempMax: 20,
        minHumidity: 40,
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Iconic Spring Flower", "Variety"],
        price: 5,
        type: "outdoor",
        ...
        overallHabit: "Upright",
        biometricFeatures: ["Tunicated Bulb", "6 Tepals"]
    },
    {
        id: "p_out_13",
        name: "Magnolia",
        ...
        sunlight: "high",
        oxygenLevel: "very-high",
        medicinalValues: ["Bark (Anxiety)"],
        advantages: ["Year-round Foliage", "Showstopper"],
        price: 150,
        type: "outdoor",
        ...
        biometricFeatures: ["Rusty Underside", "Aggregate Fruit"]
    },
    {
        id: "p_out_14",
        name: "Bamboo",
        ...
        imageUrl: "https://images.unsplash.com/photo-1596720512803-085e481b4986", // Generic plant background
        idealTempMin: -10,
        idealTempMax: 35,
        minHumidity: 50,
        sunlight: "high",
        oxygenLevel: "very-high",
        medicinalValues: ["Silica source"],
        advantages: ["Fastest Growing", "Sustainable Material"],
        price: 60,
        type: "outdoor",
        ...
        biometricFeatures: ["Nodes/Internodes", "Hollow Stem"]
    },
    {
        id: "p_out_15",
        name: "Marigold",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Skin Healing", "Eye Health (Lutein)"],
        advantages: ["Pest Repellent", "Continuous Bloom"],
        price: 6,
        type: "outdoor",
        ...
        stemStructure: "Herbaceous",
        overallHabit: "Bushy",
        biometricFeatures: ["Pungent Scent", "Composite Flower"]
    },
    {
        id: "p_out_16",
        name: "Thyme",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Antimicrobial", "Respiratory"],
        advantages: ["Ground Cover", "Edible"],
        price: 8,
        type: "outdoor",
        ...
        biometricFeatures: ["Square Stem", "Opposite Leaves"]
    },
    {
        id: "p_out_17",
        name: "Bougainvillea",
        ...
        imageUrl: "https://images.unsplash.com/photo-1563217684-28b9d2423e80", // Lavender img fallback
        idealTempMin: 5,
        idealTempMax: 35,
        minHumidity: 40,
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Drought Tolerant", "Intense Color"],
        price: 45,
        type: "outdoor",
        foliageTexture: "Smooth",
        ...
        biometricFeatures: ["Colorful Bracts", "Axillary Thorns"]
    },
    {
        id: "p_out_18",
        name: "Fern (Outdoor)",
        ...
        sunlight: "low",
        oxygenLevel: "high",
        medicinalValues: ["Traditional Pain Relief"],
        advantages: ["Erosion Control", "Winter Greenery"],
        price: 20,
        type: "outdoor",
        ...
        overallHabit: "Clumping",
        biometricFeatures: ["Sori rows", "Chaffy scales"]
    },
    {
        id: "p_out_19",
        name: "Dahlia",
        ...
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Insulin (Historical)"],
        advantages: ["Cut Flower", "Diverse Forms"],
        price: 12,
        type: "outdoor",
        ...
        overallHabit: "Bushy",
        biometricFeatures: ["Tuberous Roots", "Composite Head"]
    },
    {
        id: "p_out_20",
        name: "Wisteria",
        ...
        oxygenLevel: "high",
        medicinalValues: ["None"],
        advantages: ["Romantic Aesthetic", "Fragrance"],
        price: 55,
        type: "outdoor",
        foliageTexture: "Smooth",
        leafShape: "Pinnate (Compound)",
        ...
        biometricFeatures: ["Velvety Pods", "Raceme Inflorescence"]
    },
    {
        id: "p_out_21",
        name: "Juniper",
        ...
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["Antiseptic (Berries)"],
        advantages: ["Screening", "Bird Habitat"],
        price: 40,
        type: "outdoor",
        ...
        biometricFeatures: ["Blue 'Berries' (Cones)", "Aromatic foliage"]
    },
    {
        id: "p_out_22",
        name: "Agave",
        ...
        imageUrl: "https://images.unsplash.com/photo-1567331140054-3839d67562f8", // Agave-like aloe img
        idealTempMin: -5,
        idealTempMax: 40,
        minHumidity: 10,
        sunlight: "high",
        oxygenLevel: "moderate",
        medicinalValues: ["Sweetener (Nectar)", "Antiseptic"],
        advantages: ["Xeriscaping", "Structural"],
        price: 50,
        type: "outdoor",
        ...
        overallHabit: "Mounding",
        biometricFeatures: ["Terminal Spine", "Imprint patterns"]
    },
    {
        id: "p_out_23",
        name: "Morning Glory",
        ...
        oxygenLevel: "moderate",
        medicinalValues: ["None"],
        advantages: ["Quick Cover", "Pollinators"],
        price: 5,
        type: "outdoor",
        ...
        biometricFeatures: ["Funnel Flower", "Twining Stem"]
    },
    {
        id: "p_out_24",
        name: "Hibiscus",
        ...
        sunlight: "high",
        oxygenLevel: "high",
        medicinalValues: ["Tea (Blood Pressure)"],
        advantages: ["Tropical Flair", "Edible Flowers"],
        price: 35,
        type: "outdoor",
        ...
        stemStructure: "Woody",
        overallHabit: "Bushy",
        biometricFeatures: ["Prominent Stamen Column", "5 Petals"]
    },
    {
        id: "p_out_25",
        name: "Hostas (Blue)",
        ...
        stemStructure: "Rhizomatous",
        overallHabit: "Mounding",
        biometricFeatures: ["Glaucous coating", "Parallel veins"]
    },
    // ... Additional outdoor plants can be added here
];
